...
cp .templates/web/config/nginx/NG01.conf ./volumes/WebServ/ngnix01/config/conf.d/site.conf;
...
cp .templates/web/config/nginx/NG02.conf ./volumes/WebServ/ngnix02/config/conf.d/site.conf;