...
cp .templates/web/nginx/index.php ./volumes/WebServ/ngnix01/www/html/index.php \
cp .templates/web/nginx/site.conf ./volumes/WebServ/ngnix01/config/conf.d/site.conf \
...
cp .templates/web/php/php.ini ./volumes/WebServ/php7/php.ini/php.ini \
cp .templates/web/php/uploads.ini ./volumes/WebServ/php7/config.d/uploads.ini  \
